...
for(var i=0; i<l; i++) {
    ...
    var f=this;
    const c=f.parentElement, a=document.createElement("div");
    a.id="gg-screen";
    container.prepend(a);
    ...
    a.innerHTML='<div class="gg-image"></div><div class="gg-close gg-btn">&times</div>' +
    '<div class="gg-next gg-btn">&rarr;</div><div class="gg-prev gg-btn">&larr;</div>';
    const k=images[0].src, q=images[l-1].src;
    const o=document.querySelector(".gg-image"), e=document.querySelector(".gg-prev"), b=document.querySelector(".gg-next"), 
