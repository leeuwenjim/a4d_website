"""
Django settings for a4d project.
...
WSGI_APPLICATION = 'a4d.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'a4d.authentication.CsrfExemptSessionAuthentication',
